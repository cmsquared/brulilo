...
c12pg = Reaction((-1, C12), (1, prot), (1, N13))
n13beta = Reaction((-1, N13), (1, C13))
c13pg = Reaction((-1, C13), (1, prot), (1, N14))
n14pg = Reaction((-1, N14), (1, prot), (1, O15))
o15beta = Reaction((-1, O15), (1, N15))
n15pg = Reaction((-1, N15), (1, O16))
n15pa = Reaction((-1, N15), (-1, prot), (1, C12), (1, alfa))
o16pg = Reaction((-1, O16), (1, F17))
f17beta = Reaction((-1, F17), (1, O17))
o17pa = Reaction((-1, O17), (-1, prot), (1, N14), (1, alfa))
